...
- Atende diretamente à diretriz do usuário: *"ira utilizar Tailwind, componetizacao shadcn-ui"*.
...
### Decisão
Manter uma **vitrine contínua unificada sem abas de categorias** (em estrita concordância com a Decisão de Esclarecimento nº 2 do usuário: *"nao tera categorias"*).
...
### Decisão
A adição de peças à Sacola de Desejos é feita com um clique direto sobre o cartão de produto, sem modais ou seletores de tamanho no catálogo (Decisão de Esclarecimento nº 1: *"sem seleção de tamanho no catálogo"*).
- A Sacola de Desejos é exibida em gaveta lateral deslizante (*Sheet/Drawer* no estilo shadcn/ui).
