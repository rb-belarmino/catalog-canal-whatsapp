...
**Goal**: Possibilitar adição à sacola com 1 clique direto (sem grade de tamanho no catálogo), visualização em gaveta lateral deslizante (_Sheet_) e encaminhamento direto para o WhatsApp oficial da vendedora.
