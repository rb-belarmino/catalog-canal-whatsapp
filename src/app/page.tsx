...
import { TopAnnouncementBar } from "@/modules/catalog/components/top-announcement-bar";
  ...
  return (
    <SearchProvider>
      <div className="min-h-screen flex flex-col bg-[#F7F7F7]">
        {/* Top Announcement Bar (Canal Concept Benefits/Perks) */}
        <TopAnnouncementBar announcement={config.topAnnouncement} />
        ...
        <main className="flex-1 max-w-7xl w-full mx-auto px-4 sm:px-6 py-6 sm:py-10">
          {config.dbError && (
            <div className="mb-6 p-4 bg-white border border-amber-200 text-amber-900 text-xs sm:text-sm">
              ...
              <p className="text-amber-800 text-xs">
                O banco de dados PostgreSQL ainda não foi alcançado em <code className="bg-neutral-100 px-1 py-0.5 rounded">DATABASE_URL</code>.
                Insira a string de conexão no arquivo <code className="bg-neutral-100 px-1 py-0.5 rounded">.env</code> e execute <code className="bg-neutral-100 px-1 py-0.5 rounded">npx prisma db push</code>.
              </p>
            </div>
          )}
          ...
          <div className="mb-6 sm:mb-8 text-center">
            ...
            <p className="text-neutral-500 text-[11px] sm:text-xs tracking-[1px] uppercase mt-1">
              Selecione suas peças favoritas e finalize o atendimento exclusivo via WhatsApp
            </p>
          </div>
        ...
        {/* Minimalist Footer */}
        <footer className="border-t border-[#E2E2E2] bg-white py-8 text-center text-xs text-neutral-500 tracking-[1.5px] uppercase">
